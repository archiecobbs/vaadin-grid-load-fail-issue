...
org.slf4j.LoggerFactory.getLogger(this.getClass()).info("**** COMPONENT RENDERER: getTemplateExpression(): UI.getCurrent()={} appId=\"{}\"", UI.getCurrent(), appId, new Throwable("HERE"));
